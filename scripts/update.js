...
function updateActiveTasks(activeTasks) {
    ...
    for (let i = 0; i < activeTasks.length; i++) {
        ...
        let newActiveTask = 
        `
        <div class="task active-task flex items-start gap-5 rounded-xl border-1 border-[var(--neutral-8)] py-3 px-5 relative w-full
...
function updateCompletedTasks(completedTasks) {
    ...
    for (let i = 0; i < completedTasks.length; i++) {
        ...
        `
        <div class="task completed task flex w-full px-3 py-5 items-center justify-between mx-2 relative rounded-xl border-1 border-[var(--neutral-8)]
        dark:bg-[var(--background-dark-2)] dark:border-none md:w-full">
